...
public class Enigma1{
  public static void main(String []arg){
   ...
   if (x>=0 && x <100){
       x = (100-x)/100;
       System.out.println("The proportion remaining is " + x);
...
/* Error report: 
The first problem is that the program will only work for the percentages that are explicitely stated in the program
this will not work for any other input. This must be changed to a simple statement that encompasses all inputs
